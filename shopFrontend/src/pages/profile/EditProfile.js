  ...
  const saveProfile = async e => {
    ...
    try {
      ...
      if (profileImage && (profileImage.type === "image/jpeg" || profileImage.type === "image/jpg" || profileImage.type === "image/png")) {
        ...
        image.append("cloud_name", "dfawesi3s");
        image.append("upload_preset", "eoxndovh");

        // First save image to cloudinary
        const response = await fetch("https://api.cloudinary.com/v1_1/dfawesi3s/image/upload", { method: "post", body: image });
